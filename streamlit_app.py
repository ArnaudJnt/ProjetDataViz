...
st.write("""
Bienvenue sur ce dashboard interactif dédié à l'analyse des accidents motorisés en 2023.
Naviguez entre les sections à l'aide du sommaire situé à gauche.
""")
